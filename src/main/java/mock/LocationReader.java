 ...
 * interfaces: Reader for reading from it, Location for diagnostic purposes. !!Prepared for mock
 * testing by dependency injection: Imports 2 interfaces: Reader, String sourceName. The composition
...
public class LocationReader extends Reader implements Location {
  ...
  /**
   * Composes a LocationReader using a Reader as import interface, and a name identifying it as a
   * data source.
   */
