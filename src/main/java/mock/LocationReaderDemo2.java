...
import blackbox.LocationReaderDemo1;
 ...
 * Demonstrates the composition of a LocationReader 
 * from an internal LineNumberReader and an imported FileReader. 
...
public class LocationReaderDemo2 {
	...
	public static void main(final String[] args) throws IOException {
        final String fileName = args.length == 0 ? "src/main/java/mock/LocationReaderDemo2.java" : args[0];
