...
/**
 * Makes a white-box test, using an active mock object, if a LocationReader, which is reading from a
 * Reader, gives the correct Location infos (source name, and line number).
 */
public class LocationReaderMockTest extends Assert {
  ...
  public void location() throws Exception {
    ...
    // We do not need to write any content into the data source, as it is actively participating in
    // the test!
