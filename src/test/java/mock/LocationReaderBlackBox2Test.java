...
/**
 * Makes a black-box test, if a LocationReader, which is reading from a Reader, gives the correct
 * Location infos (source name, and line number).
 */
public class LocationReaderBlackBox2Test extends Assert {
  ...
  public void location() throws Exception {
    ...
    final LocationReader reader =
        new LocationReader(new StringReader(testText1.toString()), testText1Name);
    System.out.println(
        "Now reading from StringReader on generated String named: " + reader.getSourceName());
    for (; ; ) {
